...
export default function CallToAction() {
  return (
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-black overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className='relative rounded-2xl overflow-hidden bg-gradient-to-br from-[#1A1A1A] to-[#2A2A2A] p-1'>
