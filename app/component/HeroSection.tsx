...
export default function HeroSection() {
  return (
    <section className="text-white bg-[#0F0F0F] relative w-full pt-0 pb-8 flex flex-col items-center justify-center px-4 md:px-6 mb-8 overflow-hidden">
      <nav className="flex justify-center items-center bg-black space-x-4 md:space-x-20 border-4 border-white rounded-full py-3 px-4 md:px-8 mb-6 text-sm">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start justify-between w-full max-w-6xl relative">
        <div className="flex-1 w-full order-1 md:order-1 text-center md:text-left space-y-6 relative py-10">
          <div className="mt-8">
            ...
            <h1 className="text-4xl md:text-7xl relative z-20 pt-2" style={{ fontFamily: 'var(--font-caveat)' }}>
              I'm <span className="text-[#EA3402]">Amandine</span>
            </h1>

            <h2 className="text-6xl sm:text-8xl lg:text-[12rem] font-bold leading-none relative z-0">
              D<span className="text-[#EA3402]">E</span>SIGNER
            </h2>

            <div className="flex flex-col gap-8 md:flex-row md:justify-start mt-2 w-full">
              ...
              <div className="flex space-x-4 justify-center md:justify-start border-2 rounded-full p-1 bg-white mx-auto md:mx-0 mt-0 md:mt-8">
        ...
        <div className="w-full md:w-auto order-2 md:order-2 flex justify-center md:justify-start mt-16 md:mt-0 pb-20 md:pb-0">
          <div className="absolute md:-top-[25px] md:left-[calc(60%+120px)] w-60 h-auto z-20">
            <Image
            ...
            >
              {[...Array(4)].map((_, i) => (
                <div key={i} className="flex items-center">
                  ...
                  <span className="text-white/50 font-extrabold min-w-max text-lg md:text-xl">
                    /
                  </span>
                  <div className="flex flex-row gap-2 min-w-max items-center mx-8 md:mx-16">
                    <FaFigma size={20} />
